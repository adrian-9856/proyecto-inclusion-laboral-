  ...
  try {
    ...
    ui.createMenu('🍔 Alimentos y Bebidas')
      ...
      .addSubMenu(ui.createMenu('📝 Gestión de Notas')
        ...
        .addSeparator()
        .addItem('📚 Actualizar Solo Históricas (antes 2026)', 'actualizarNotasHistoricasAB')
        .addItem('🆕 Actualizar Solo Nuevas (2026)', 'actualizarNotasNuevasAB')
        .addSeparator()
        .addItem('🗑️ Limpiar Todas las Notas', 'limpiarTodasLasNotasAB'))
      .addSeparator()
      ...
      .addSeparator()
      .addItem('📊 Guardar Reporte Mensual', 'guardarReporteMensualAutomaticoAB')
      .addItem('💾 Crear PowerBI Export', 'crearHojaPowerBIExportAB')
      .addSeparator()
      ...
      .addSubMenu(ui.createMenu('🛠️ Herramientas')
        ...
        .addItem('🔧 Reparar Hoja de Interés (con backup)', 'repararHojaInteresAB')
        .addSeparator()
      ...
      .addItem('🕵️ Diagnóstico Fechas Kobo', 'diagnosticarFechaKoboAB')
...
function configurarValidaciones() {
  ...
  if (entrevistas) {
    ...
    entrevistas.getRange('N2:N500').setDataValidation(
      SpreadsheetApp.newDataValidation().requireValueInList(CONFIG_AB.RESULTADO_FINAL).setAllowInvalid(false).build()
    );
  }
