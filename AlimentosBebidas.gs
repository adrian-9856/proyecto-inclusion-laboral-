 ...
 * - Flujo automático: Interés → Entrevistas → Seleccionadas → Cohorte
 * - Limpieza automática entre etapas
 *
 * =====================================================================
 */
...
function onOpen() {
  ...
  ui.createMenu('🍽️ Alimentos y Bebidas')
    ...
    .addSubMenu(ui.createMenu('📥 Importar Datos')
      ...
      .addItem('📊 Ver Columnas Alimentos', 'verColumnasKobo')
...
function crearHojaReporte() {
  ...
  const data = [
    ['REPORTE - INCLUSIÓN LABORAL ALIMENTOS Y BEBIDAS', '', '', ''],
 ...
 * - Inclusión Laboral/.../Alimentos y Bebidas - Gastronomía
 * - Inclusión Laboral/.../Alimentos y Bebidas - Barismo
 */
...
function crearNuevaCohorte() {
  ...
  const datosCohorte = [nombre, 'Alimentos y Bebidas', '', '', responsable, cupo, '', '', '', '', '', '', '', estadoInicial];
...
function crearDatosPrueba() {
  ...
  const datosPrueba = [
    ['', '', 'CR001', '1234567890101', 'María García', '22', '5555-1234', 'Diversificado completo', 'Zona 1', 'Redes', 'Gastronomía', 'Adrian Torres', '', 'Nuevo'],
    ['', '', 'CR002', '2345678901212', 'Ana Martínez', '25', '5555-5678', 'Universitario', 'Zona 7', 'Referido', 'Barismo', 'Paola Ortiz', '', 'Nuevo'],
    ['', '', 'CR003', '3456789012323', 'Laura López', '19', '5555-9012', 'Básicos completos', 'Mixco', 'Facebook', 'Gastronomía', 'Adrian Torres', '', 'Nuevo']
  ];
